...
% -------------------------------------------------------------------------
%SA = gsw_SR_from_SP(SP);
%theta = gsw_pt_from_t(SA,t,p,0.); 
%ct = gsw_CT_from_pt(SA,theta); 

SA = [35.231351218285731
  35.251445526857161
  35.254459673142875
  35.243407803428589
  35.190157885714299
...
% ----------------------------------------------------
gammat_eos80_known = [26.657642122200624
  26.682675341378676
  26.710513181280987
  26.723199400583702
  26.742447574193090
...
gammat_teos10_known = [26.657891374558027
  26.682917735211849
  26.710730614357313
  26.723394437919261
  26.742576785599134
...
if any(abs(gammat_eos80_known - gammat_eos80) > 1e-6)
   fprintf(2,['Your installation of gsw_gammat_analytic_theta_eos80 ...' ...
       ' has errors !\n']);
else
    fprintf(1,'This check function confirms that the \n');
    fprintf(1,'gsw_gammat_analytic_theta_eos80 is installed correctly.\n');
end

if any(abs(gammat_teos10_known - gammat_teos10) > 1e-6)
   fprintf(2,['Your installation of gsw_gammat_analytic_CT ...' ...
       ' has errors !\n']);
else
    fprintf(1,'This check function confirms that the \n');
    fprintf(1,'gsw_gammat_analytic_CT is installed correctly.\n');
end
